...
class Spider(Spider):
    ...
    def playerContent(self, flag, id, vipFlags):
        ...
        try:
            ...
            if PLAYWRIGHT_AVAILABLE:
                direct_url = self._extract_direct_with_playwright(play_url)
                if direct_url:
                    return {
                        'parse': 0,
                        'url': direct_url,
    ...
    def _extract_direct_with_playwright(self, play_url):
        """
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                context = browser.new_context(
                    ...
                    extra_http_headers={'Referer': self.url}
                )
